        ...
        <>
            <div className='w-full flex justify-between items-center font-semibold'>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <p className='bg-black py-1.5 px-3 rounded-2xl text-[15px] cursor-pointer'>Install App</p>
                    <p className='bg-[#6660ff] text-black w-7 h-7 rounded-full flex items-center justify-center'>P</p>
                </div>
            </div>
